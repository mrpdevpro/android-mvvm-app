...
public class ViewModelsModule {
    @Provides
    public AdDetailViewModel providesAdDetailViewModel(AdDetailDomainService service, CommunicationService communicationService, TextProvider textProvider){
        return new AdDetailViewModel(service,communicationService,textProvider) ;
    }
